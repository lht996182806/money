...
$input->SetNotify_url("http://www.520jpj.com/Extend/weipay/native_notify.php");
...
<head>
	...
	function successjs()
	{
		...
		// 	if(ret == 2)
		// 	{
			  	window.location.href="http://www.520jpj.com/index.php/Home/User/notify/?order_id=<?php echo $_REQUEST['order_id'] ?>";
		// 	}
		// });
