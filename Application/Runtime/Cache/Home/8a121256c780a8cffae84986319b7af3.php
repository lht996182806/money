...
<form id="DepositForm" class="ng-pristine ng-valid" method="post" action="http://www.520jpj.com/Extend/weipay/jsapi.php"> 
        ...
        <div class="row field-row">
           <!--  <div class="col-xs-6 btn-group">
            ...
            <input id="order_id" type="hidden"  name="order_id" value="<?php echo ($balc["bpno"]); ?>">
                <input id="DepositAmount" type="text" class="form-control ng-pristine ng-untouched ng-valid needsclick" value="<?php echo ($balc["bpprice"]); ?>" name="tfee">
            </div>
        </div>
    </div>
    ...
    <div class="container">
       <!--  <div class="row field-row">
        ...
        <div class="row">
            <button class="btn btn-primary btn-block"  ng-disabled="btnDepositDisabled" type="submit">提交充值</button>
        </div>
    </div>
</form>
