    ...
    <div class="container-fluid">
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row-fluid form-wrapper">
            	<form action="<?php echo U('Goods/gtedit');?>" method="post">
                <!-- left column -->
                <div class="span8 column">
                	<input name="cid" type="hidden" value="<?php echo ($gt['cid']); ?>"/>
					<div class="field-box">
						<label>分类名称：</label>
						<input class="span8" type="text" data-toggle="tooltip" data-trigger="focus"  data-placement="right" name="cname" value="<?php echo ($gt['cname']); ?>" disabled="disabled" />
					</div>
                    <div class="field-box">
                        <label>点差价格：</label>
                        <input class="span8" type="text" data-toggle="tooltip" data-trigger="focus"  data-placement="right" name="myat" value="<?php echo ($gt['myat']); ?>"/>
                    </div>
                ...
                <div class="span4 column pull-right">
				   ...
				   <div class="field-box">点差价格正常是100，变成99则前台价格会减少1%，变成101，则会增加1%的价格</div>
                </div>
            </div>
        </div>
    </div>
